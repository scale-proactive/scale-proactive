...
/**
 * GCM example with "One-to-one" distribution of parameters.
 * The master component will break items in the list passed to it, and will distribute the items to slave in one-to-one fashion.
 * Note: The number of items in list must be equal to number of slaves attached to master
 */
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //as we have 3 slaves, we need 3 items in list for one-to-one distribution of parameters.
