...
/**
 * GCM example with "UNICAST" distribution of list parameter.
 * Note: Their should be only 1 item in the list to make unicast work.
 * This item can be sent to any of the worker binded to master
 */
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //There should be only one item in the list in UNICAST mode. This item can be send to any one of the three slaves
