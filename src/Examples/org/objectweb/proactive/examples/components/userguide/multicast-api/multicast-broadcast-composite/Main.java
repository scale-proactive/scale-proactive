...
/**
 * Multicast interface example with broadcast distribution of parameters. The master components multi-casts the request to 3 slaves.
 */
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /**
         * To add components to the composite component, we need to get the reference of ContentController object of "composite" component.
         */
