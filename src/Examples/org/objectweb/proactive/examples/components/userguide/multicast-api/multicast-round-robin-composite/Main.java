...
/**
 * GCM example with "Round-Robin" distribution of parameters.
 * The master component will break items in the list passed to it, and distribute the items to slave for processing in "Round-Robin" fashion.
 */
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /**
         * To add components to the Component, we need to get the reference of ContentController object of "composite" component.
         */
